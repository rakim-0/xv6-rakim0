...
CFLAGS = -fno-pic -static -fno-builtin -fno-strict-aliasing -O2 -MD -ggdb -mno-sse -m32 -Werror -fno-omit-frame-pointer
...
EXTRA=\
	...
	printf.c umalloc.c hello.c dls.c childcount-test.c nfork-test.c\
